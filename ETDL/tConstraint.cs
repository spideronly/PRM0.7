...
namespace ETDL
{
    ...
    {
        private const string mFields = "[ConstraintID],[ConstraintName],[ConstraintRequiredSolution],[ConstraintIsNeedMayor],[ConstraintIsSolved],[ConstraintResponsibleName],[ConstraintDate],[ConstraintDateHijri],[ConstraintPlanDate],[ConstraintPlanDateHijri]";
        ...
        public int Create()
        {
            ...
            mCols = "[ConstraintName],[ConstraintRequiredSolution],[ConstraintResponsibleName],[ConstraintIsNeedMayor],[ConstraintIsSolved],[ConstraintDate],[ConstraintDateHijri],[ConstraintPlanDate],[ConstraintPlanDateHijri],[Constraint_ProjectID],[ConstraintOrder],[ConstraintDMLcreateUID],[ConstraintDMLcreateDate],[ConstraintDMLactionUID],[ConstraintDMLactionDate],[ConstraintDMLactionType]";
