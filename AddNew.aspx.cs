...
public partial class AddNew: myFilteredPage
{
    int myProjID;
    int myDepID;
    ...
    protected void RbTask_CheckedChanged(object sender, EventArgs e)
    {
        ...
        DivMubadaraName.Visible = false;
        DivTaskName.Visible = true;
    }
    protected void RbMubadrah_CheckedChanged(object sender, EventArgs e)
    {
        ...
        DivNoConDateS.Visible = true;
        DivProjectName.Visible = false;
        DivMubadaraName.Visible = true;
        DivTaskName.Visible = false;
    }
    ...
    protected void ImgBtnSave_Click(object sender, ImageClickEventArgs e)
    {
            ...
            try
            {
                if (TxtProjectName.Text == "" || DlDep.SelectedValue == "0" || txtEndDate.Date == new DateTime() || txtStartDate.Date == new DateTime() || txtFromDateReport.Date == new DateTime() || txtToDateReport.Date == new DateTime())
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "gg1", "alert(' أدخل البيانات اولاً . التي تظهر أمامها علامه* باللون الأحمر');", true);
                    return;
                }
                else
                {
